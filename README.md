...
1. Выберите любую технологию (тематику) из списка, представленного в репозитории [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x).
...
В рамках проектной практики для реализации технологии была выбрана Комондная сторока ([Command-Line Tool]([Command-Line Tool](https://github.com/codecrafters-io/build-your-own-x?tab=readme-ov-file#build-your-own-command-line-tool)))
